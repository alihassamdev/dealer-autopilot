...
const Hero = () => {
  return (
    <section className="px-5 pb-[78px] md:pb-[68px]">
      <div className="w-full max-w-[1240px] mx-auto flex flex-col items-center">
        ...
        <div className="mb-[48px] md:mb-[68px]">
          <AnimatedText
            ...
            direction="top"
            delay={0.2}
            className="tracking-[-0.8%] capitalize text-[30px] leading-12 md:tracking-[-1.2%] md:text-[60px] md:leading-[70px] font-bold"
          />
        </div>
